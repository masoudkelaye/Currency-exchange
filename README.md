...
این برنامه از **سیستم هوشمند چند لایه** برای دریافت نرخ ارز استفاده می‌کند:

### ۱. منبع اصلی: **[baha24.com](https://baha24.com)** — نرخ بازار آزاد 🟢
```
GET https://baha24.com/api/v1/price
```
- ✅ نرخ‌های واقعی بازار آزاد ایران
- ✅ رایگان، بدون نیاز به کلید API
- ⚠️ ممکن است به دلیل CORS در برخی مرورگرها بلاک شود

### ۲. منبع جایگزین: **[open.er-api.com](https://www.exchangerate-api.com)** — نرخ رسمی 🟡
```
...
اگر API بازار آزاد به هر دلیلی (CORS، قطعی، ...) در دسترس نباشد، برنامه به صورت خودکار از منبع جایگزین استفاده می‌کند و به کاربر اطلاع می‌دهد (نشانگر زرد رنگ در بالای صفحه).
